module Haystack
  class Aggregator
    ...
    #
    # @returns [ Array ] Array of post processed Haystack::Transaction objects
    def post_processed_queue!
      Haystack.logger.debug("Post processing queue: #{counts.inspect}")
      Haystack::Aggregator::PostProcessor.new(queue).post_processed_queue!
    end
