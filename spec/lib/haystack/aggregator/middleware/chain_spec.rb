...
describe Haystack::Aggregator::Middleware do
  let(:chain_klass) { Haystack::Aggregator::Middleware::Chain }
  let(:entry_klass) { Haystack::Aggregator::Middleware::Entry }
  let(:chain) { chain_klass.new }
  let(:entry) { entry_klass.new(object, {:foo => :bar}) }

  describe Haystack::Aggregator::Middleware::Chain do
  ...
  describe Haystack::Aggregator::Middleware::Entry do
