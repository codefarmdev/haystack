...
if active_record_present?
  ...
  require 'haystack/aggregator/middleware/active_record_sanitizer'

  describe Haystack::Aggregator::Middleware::ActiveRecordSanitizer do
    let(:klass) { Haystack::Aggregator::Middleware::ActiveRecordSanitizer }
