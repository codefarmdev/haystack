    ...
    context "logs" do
      shared_examples_for "logging info and errors" do
        it "should log status 200" do
          ...
          log.string.should include('Notifying Haystack of deploy with: revision: 503ce0923ed177a3ce000005, user: batman')
          log.string.should include('Haystack has been notified of this deploy!')
        end
        ...
        it "should log other status" do
          ...
          log.string.should include(
            'Something went wrong while trying to notify Haystack: 500 at http://localhost:3000/1/markers'
          )
          log.string.should_not include(
            'Haystack has been notified of this deploy!'
          )
        end
      end
